        ...
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-gray-800/80 dark:to-black/80 backdrop-blur-sm rounded-xl p-6 mb-6 shadow-xl border-2 border-blue-300 dark:border-yellow-500/30">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-black text-slate-900 dark:text-white mb-1">{materialData.title}</h1>
                <p className="text-base text-slate-700 dark:text-gray-300 mb-1">{materialData.titleAr}</p>
                <p className="text-blue-700 dark:text-yellow-400 font-bold text-base">{materialData.code}</p>
              </div>
            </div>
            <div className="text-right bg-blue-100 dark:bg-gray-700/50 rounded-lg p-4 border-2 border-blue-300 dark:border-yellow-500/30">
              <div className="text-blue-700 dark:text-yellow-400 font-bold text-base">Year {materialData.year}</div>
              <div className="text-sm text-slate-600 dark:text-gray-400">السنة {materialData.year}</div>
              <div className="text-slate-700 dark:text-gray-300 font-medium text-sm">{materialData.term}</div>
            </div>
          </div>
        </div>
                    ...
                    <div key={video.id} className="group bg-gradient-to-br from-purple-50 to-purple-100 dark:from-gray-700/30 dark:to-gray-800/30 backdrop-blur-sm rounded-2xl p-6 border-2 border-purple-300 dark:border-gray-600/30 hover:border-purple-500 dark:hover:border-blue-500/50 hover:bg-purple-100 dark:hover:bg-gray-700/50 transition-all duration-300">
                      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="lg:col-span-2">
                          ...
                          {/* Playlist Info */}
                          <div className="mt-3 p-3 bg-blue-100 dark:bg-blue-500/10 border-2 border-blue-300 dark:border-yellow-500/30 rounded-lg">
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="space-y-2 text-sm text-slate-600 dark:text-gray-400">
                            <div className="flex items-center justify-between">
                              <span>النوع:</span>
                              <span className="text-slate-900 dark:text-white font-medium">Playlist</span>
                            </div>
                            <div className="flex items-center justify-between">
                              <span>تاريخ الرفع:</span>
                              <span className="text-slate-900 dark:text-white font-medium">{video.uploadedAt}</span>
                            </div>
                          </div>

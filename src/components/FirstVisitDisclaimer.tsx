...
🚫 ممنوع منعاً باتاً استخدام أي محتوى داخل الموقع يخص الكلية
🚫 استخدامك  لهذا المحتوى خارج نطاق المنصه يعرضك للمساءلة القانونية
🚫 ممنوع منعاً باتاً استخدام إيميلك الجامعي عند تسجيل الدخول في الموقع

📋 شروط الاستخدام:
• هذا الموقع ليس له علاقه بادارة الجامعة

        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex justify-between items-center py-4">
            ...
            <Link href="/" className="flex items-center space-x-3 group">
              <div className="w-12 h-12 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-2xl flex items-center justify-center shadow-lg shadow-cyan-500/30 group-hover:shadow-cyan-500/50 transition-all duration-300 group-hover:scale-105">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400 -mt-1">جامعة الزقازيق</p>
              </div>
            </Link>

            {/* Desktop Navigation */}
            <nav className="flex space-x-8">
              <Link href="/" className="text-gray-300 hover:text-cyan-400 transition-colors font-medium text-lg group">
                <span className="group-hover:scale-105 transition-transform duration-300">الرئيسية</span>
              </Link>
              <Link href="/about" className="text-gray-300 hover:text-cyan-400 transition-colors font-medium text-lg group">
                <span className="group-hover:scale-105 transition-transform duration-300">من نحن</span>
              </Link>
              <Link href="/contact" className="text-gray-300 hover:text-cyan-400 transition-colors font-medium text-lg group">
                <span className="group-hover:scale-105 transition-transform duration-300">تواصل معنا</span>
              </Link>
              {user && (user.role === 'admin' || user.role === 'super_admin') && (
                <Link href="/admin" className="text-gray-300 hover:text-red-400 transition-colors font-medium text-lg group">
      ...
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-gray-900/95 backdrop-blur-sm border-t border-gray-700/50 z-50">
        <div className="px-2 py-3">
          <div className="flex justify-around items-center">
            ...
            <Link
              href="/"
              className="flex flex-col items-center justify-center p-2 rounded-xl transition-all duration-300 group min-w-0 flex-1"
            >
              ...
              <span className="text-xs text-gray-400 group-hover:text-cyan-400 font-medium">الرئيسية</span>
            </Link>
            ...
            >
              ...
              <span className="text-xs text-gray-400 group-hover:text-cyan-400 font-medium">من نحن</span>
            </Link>
            ...
            >
              ...
              <span className="text-xs text-gray-400 group-hover:text-cyan-400 font-medium">تواصل معنا</span>
            </Link>
            ...
            >
              ...
              <span className="text-xs text-gray-400 group-hover:text-cyan-400 font-medium">
            ...
            {user && (user.role === 'admin' || user.role === 'super_admin') && (
              ...
              >
                ...
                <span className="text-xs text-gray-400 group-hover:text-red-400 font-medium">الإدارة</span>
              </Link>
            )}
          </div>
        </div>

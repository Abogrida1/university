...
export default function LectureSchedule({ user, departmentOverride, yearOverride, termOverride, refreshTrigger }: LectureScheduleProps) {
    ...
    return (
      <div className="bg-gradient-to-br from-gray-800/80 to-black/80 backdrop-blur-sm rounded-3xl p-8 max-w-6xl mx-auto border border-yellow-500/30 shadow-2xl shadow-yellow-500/20 mb-8">
        <div className="text-center">
          ...
          <p className="text-yellow-300 text-lg">جاري تحميل جدول المحاضرات...</p>
        </div>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="bg-gradient-to-br from-gray-800/80 to-black/80 backdrop-blur-sm rounded-3xl p-8 max-w-6xl mx-auto border border-red-500/30 shadow-2xl shadow-red-500/20 mb-8">
        <div className="text-center">
    ...
    return (
      <div className="bg-gradient-to-br from-gray-800/80 to-black/80 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-6 sm:p-8 max-w-6xl mx-auto border border-yellow-500/30 shadow-2xl shadow-yellow-500/20 mb-6 sm:mb-8">
        <div className="text-center mb-4 sm:mb-6">
          ...
          {schedule.size && (
            <p className="text-xs sm:text-sm text-yellow-300 mt-2">الحجم: {schedule.size}</p>
          )}
        </div>
          ...
          {schedule.fileUrl && (
            <>
              ...
              <button
                ...
                className="hidden md:flex bg-gradient-to-r from-yellow-500 to-yellow-600 text-black px-4 sm:px-6 py-2 sm:py-3 rounded-lg sm:rounded-xl font-bold hover:from-yellow-600 hover:to-yellow-700 transition-all duration-300 items-center gap-2 text-sm sm:text-base"
              ...
              <button
                onClick={() => {
                  ...
                  try {
                    ...
                    link.download = schedule.fileName || 'schedule.pdf';
                    link.target = '_blank';
                    ...
                    console.log('✅ Schedule download initiated');
                  } catch (err) {
        ...
        {showPreview ? (
          schedule.fileUrl ? (
            <div className="hidden md:block w-full h-[80vh] bg-black/30 rounded-xl overflow-hidden border border-yellow-500/30">
